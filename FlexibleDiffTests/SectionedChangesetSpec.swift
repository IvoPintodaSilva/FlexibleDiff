...
class SectionedChangesetSpec: QuickSpec {
	override func spec() {
		...
		describe("mutation") {
			...
			it("should reflect a mutation in the section items and its items") {
				diffTest(
					previous: [
						Section(identifier: "A", metadata: "old", items: [])
					],
		...
		describe("move") {
			...
			it("should reflect a section moved with section change") {
				diffTest(
					previous: [
						Section(identifier: "A", metadata: "old", items: []),
			...
			it("should reflect a section moved with item and section mutations made") {
				diffTest(
					previous: [
						Section(identifier: "A", metadata: "old", items: [
							Section.Item(identifier: "A0", value: .max)
